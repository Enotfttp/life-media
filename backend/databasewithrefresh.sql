...
ADD CONSTRAINT fk_users_security_user FOREIGN KEY (security_user_id) REFERENCES security_user(id) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- DROP TABLE chat_statuses CASCADE;
